...
Para análise dos dados foi utilizada a [linguagem R] (http://www.R-project.org/) A base de dados da amostra de tempos de execução é apresentada abaixo:
...
Como interpretação do valor de **d**, optou-se por utilizar os valores de referência mostrados em @Cohen1988 @CONBOY2003 @ESPIRITO_SANTO2015 @LOUREIRO2011 onde são considerados:
...
segundo @Cohen1998, quando o investigador não tem outra base para definir o valor da potência, usa-se o valor 0.80, ou seja, $\beta=0.20$


## Análise Estatística
Inicialmente utilizou-se o teste estatístico para a média. Como a variância é desconhecida e têm-se um tamanho amostral [pequeno](http://www.statisticshowto.com/probability-and-statistics/hypothesis-testing/t-score-vs-z-score/), foi utilizado o teste $t$ disponível no pacote _LessR_ (@lessR), de forma a gerar informações gráficas.
...
```
Uma vez que o poder do teste é menor que o limiar definido de 80% @Campelo2015-01, foi realizado novamente o teste para definir o menor tamanho amostral para um poder de teste de 80%.
